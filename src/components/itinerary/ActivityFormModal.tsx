    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <select
            className="w-full px-3 py-2 border rounded-md placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 border-static-gray-700 text-static-text-900 dark:text-static-text-50 bg-static-bg-50 dark:bg-static-bg-900"
