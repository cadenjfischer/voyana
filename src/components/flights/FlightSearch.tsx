          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-9 pr-2 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium text-sm appearance-none cursor-pointer transition-all \
